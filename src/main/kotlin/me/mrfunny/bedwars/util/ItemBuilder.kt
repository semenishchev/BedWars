...
class ItemBuilder {
    ...
    fun <T : Any>setNbtTag(key: String, type: PersistentDataType<T, T>, value: T): ItemBuilder {
        val container = `is`.itemMeta.persistentDataContainer
        container.set(NamespacedKey(me.mrfunny.bedwars.BedWars.instance, key), type, value)
        return this
    }
